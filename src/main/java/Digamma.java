...
public final class Digamma {
   ...
   * <p>
   *
   * <p>This is an independently written implementation of the algorithm described in Jose Bernardo,
   ...
   * Accuracy for negative values of x should be about 10^-8 absolute for results less than 10^5 and
   * 10^-8 relative for results larger than that.
   *
   * @param x Argument.
